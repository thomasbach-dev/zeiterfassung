...
spec = do
  describe "pAgendaLog" $ do
    ...
    it "Parses a full agenda log example" $
      let expected = 
            [(fromGregorian 2020 7 27, [ LogLine (Time 10 20) (Time 10 30) "Selbstorganisation" Q4_CONSULTING
                                       , LogLine (Time 11 25) (Time 12 40) "Fix failing tests in 3.2 Branch Tests" UPG_TO_44
                                       ])
            ,(fromGregorian 2020 7 28, [ LogLine (Time 10 45) (Time 11 05) "[INU-2697] Soap - Light2Full" Q4_CONSULTING])
  ...
  describe "pLogLine" $ do
    it "Parses a log line" $
      P.parse pLogLine "" "  gtd02:      10:20-10:30 Clocked:   (0:10) Zeiterfassung :q4_cons:\n"
        `shouldBe` Right (LogLine (Time 10 20) (Time 10 30) "Zeiterfassung" Q4_CONSULTING)
  ...
  describe "pTaskFromTags" $ do 
    it "Parses a single task" $
      P.parse pTaskFromTags "" ":q4_cons:"
        `shouldBe` Right Q4_CONSULTING
...
example2 =
  "Week-agenda (W31):\n\
   \Monday     27 July 2020 W31\n\
   \  gtd02:      10:20-10:30 Clocked:   (0:10) Selbstorganisation                         :q4_cons:\n\
   \  gtd02:      11:25-12:40 Clocked:   (1:15) TODO Fix failing tests in 3.2 Branch Tests :upg_to_44:\n\
   \Tuesday    28 July 2020\n\
   \  gtd02:      10:45-11:05 Clocked:   (0:20) TODO [INU-2697] Soap - Light2Full          :q4_cons:\n\
